/**
 * Template HTML base per le email di Nimbus.
 *
 * Fornisce il layout comune (header, contenuto, footer)
 * utilizzato da tutti i template email.
 *
 * @param {Object} params
 * @param {string} params.title - Titolo dell'email
 * @param {string} params.content - Contenuto HTML specifico
 * @returns {string} HTML completo dell'email
 */
